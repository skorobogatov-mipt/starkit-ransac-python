...
def generate_stairs_mesh(stairs: StepPlane, color=(0, 1, 0), resolution=None):
    planes = []
    thickness = 0.01
    ...
    for i in range(num_steps):
        ...
        step = o3d.geometry.TriangleMesh.create_box(
            width=stairs.step_width, height=stairs.stair_height, depth=thickness
        )
        ...
        R = step.get_rotation_matrix_from_xyz((0, 0, np.deg2rad(stairs.rotation_deg)))
        ...
        riser = o3d.geometry.TriangleMesh.create_box(
            width=thickness, height=stairs.stair_height, depth=stairs.step_height
        )
        ...
        riser.translate([(i + 1) * stairs.step_width, 0, (i) * stairs.step_height])
        ...
        R = riser.get_rotation_matrix_from_xyz((0, 0, np.deg2rad(stairs.rotation_deg)))
